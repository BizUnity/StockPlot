...
{
    public class OScatterPlotDraggable : OScatterPlot, IDraggable
    {
        ...
        public OScatterPlotDraggable(double[] xs, double[] ys, double[] errorX = null, double[] errorY = null) : base(xs, ys, errorX, errorY)
        {
            this.Xs = xs;
            this.Ys = ys;
            this.XError = errorX;
